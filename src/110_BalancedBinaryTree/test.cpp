...
class BalancedBinaryTreeParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
        ...
        static boost::json::value invoke(Solver& s, const boost::json::value& case_json) {
            ...
            return boost::json::value_from(s.isBalanced(tree.root));
        }
    };
...
TEST_P(BalancedBinaryTreeParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, BalancedBinaryTreeParamSuite, ::testing::ValuesIn(BalancedBinaryTreeParamSuite::kParams), io::gen_flatten_name);
