...
class BinaryTreeLevelOrderTraversal_IIParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
...
TEST_P(BinaryTreeLevelOrderTraversal_IIParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, BinaryTreeLevelOrderTraversal_IIParamSuite,
                         ::testing::ValuesIn(BinaryTreeLevelOrderTraversal_IIParamSuite::kParams), io::gen_flatten_name);
