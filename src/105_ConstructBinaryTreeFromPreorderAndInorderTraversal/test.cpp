...
class ConstructBinaryTreeFromPreorderAndInorderTraversalParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
...
TEST_P(ConstructBinaryTreeFromPreorderAndInorderTraversalParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, ConstructBinaryTreeFromPreorderAndInorderTraversalParamSuite,
                         ::testing::ValuesIn(ConstructBinaryTreeFromPreorderAndInorderTraversalParamSuite::kParams), io::gen_flatten_name);
