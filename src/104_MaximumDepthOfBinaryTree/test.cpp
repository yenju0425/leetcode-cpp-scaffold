...
class MaximumDepthOfBinaryTreeParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
        ...
        static boost::json::value invoke(Solver& s, const boost::json::value& case_json) {
            ...
            return boost::json::value_from(s.maxDepth(tree.root()));
        }
    };
...
TEST_P(MaximumDepthOfBinaryTreeParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, MaximumDepthOfBinaryTreeParamSuite, ::testing::ValuesIn(MaximumDepthOfBinaryTreeParamSuite::kParams),
                         io::gen_flatten_name);
