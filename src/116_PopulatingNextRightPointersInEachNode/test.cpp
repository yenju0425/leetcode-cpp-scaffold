...
class PopulatingNextRightPointersInEachNodeParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
        ...
        io::build_params_from_file(__FILE__, "test_cases.json",
                                   {
                                       ...
                                       {"IterativeV1", io::make_runner<iterative_v1::Solution, Adapter>()},
                                       {"IterativeV2", io::make_runner<iterative_v2::Solution, Adapter>()},
                                   });
};

TEST_P(PopulatingNextRightPointersInEachNodeParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, PopulatingNextRightPointersInEachNodeParamSuite,
                         ::testing::ValuesIn(PopulatingNextRightPointersInEachNodeParamSuite::kParams), io::gen_flatten_name);
