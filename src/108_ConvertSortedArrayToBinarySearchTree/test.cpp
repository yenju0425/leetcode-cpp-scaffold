...
class ConvertSortedArrayToBinarySearchTreeParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
...
TEST_P(ConvertSortedArrayToBinarySearchTreeParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, ConvertSortedArrayToBinarySearchTreeParamSuite,
                         ::testing::ValuesIn(ConvertSortedArrayToBinarySearchTreeParamSuite::kParams), io::gen_flatten_name);
