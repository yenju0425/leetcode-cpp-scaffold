...
class MinimumDepthOfBinaryTreeParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
        ...
        static boost::json::value invoke(Solver& s, const boost::json::value& case_json) {
            ...
            return boost::json::value_from(s.minDepth(tree.root));
        }
    };
...
TEST_P(MinimumDepthOfBinaryTreeParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, MinimumDepthOfBinaryTreeParamSuite, ::testing::ValuesIn(MinimumDepthOfBinaryTreeParamSuite::kParams),
                         io::gen_flatten_name);
