...
class BinaryTreeZigzagLevelOrderTraversalParamSuite : public ::testing::TestWithParam<io::CaseParam> {
public:
    struct Adapter {
...
TEST_P(BinaryTreeZigzagLevelOrderTraversalParamSuite, ExampleOutput) {
...
INSTANTIATE_TEST_SUITE_P(FromJson, BinaryTreeZigzagLevelOrderTraversalParamSuite,
                         ::testing::ValuesIn(BinaryTreeZigzagLevelOrderTraversalParamSuite::kParams), io::gen_flatten_name);
